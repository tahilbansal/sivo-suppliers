...
import 'package:sivo_suppliers/models/hook_models/hook_result.dart';
...
FetchHook useFetchPicked(String query) {
  ...
  Future<void> fetchData() async {
    ...
    String? supplier = box.read('supplierId');
    isLoading.value = true;
    try {
      Uri url = Uri.parse(
          '${Environment.appBaseUrl}/api/orders/orderslist/$supplier?status=$query');
