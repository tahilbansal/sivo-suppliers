...
class ReadyOrders {
  ...
  factory ReadyOrders.fromJson(Map<String, dynamic> json) => ReadyOrders(
        ...
        supplierId: json["supplierId"] != null
            ...
            : null,
        supplierCoords: json["supplierCoords"] != null
            ? List<double>.from(
                json["supplierCoords"].map((x) => x?.toDouble()))
            : null,
        recipientCoords: json["recipientCoords"] != null
            ? List<double>.from(
  ...
  Map<String, dynamic> toJson() => {
        ...
        "supplierCoords": supplierCoords != null
            ? List<dynamic>.from(supplierCoords!.map((x) => x))
            : null,
        "recipientCoords": recipientCoords != null
            ? List<dynamic>.from(recipientCoords!.map((x) => x))
            : null,
