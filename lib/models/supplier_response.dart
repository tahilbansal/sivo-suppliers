...
class Coords {
    ...
    factory Coords.fromJson(Map<String, dynamic> json) => Coords(
        ...
        title: json["title"],
        latitudeDelta: (json["latitudeDelta"] is int) ? (json["latitudeDelta"] as int).toDouble() : json["latitudeDelta"]?.toDouble(),
        longitudeDelta: (json["longitudeDelta"] is int) ? (json["longitudeDelta"] as int).toDouble() : json["longitudeDelta"]?.toDouble(),
    );
